...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    await client.botSettings.setMoneyRate(interaction.guild.id, parseInt(min), parseInt(max));

    const newEmbed = new EmbedBuilder()
      .setAuthor(embed.author)
      .setFooter(embed.footer)
      .setColor(embed.color)
      .setDescription(`Successfully set the Money Rate to \`${min} - ${max}\``);
