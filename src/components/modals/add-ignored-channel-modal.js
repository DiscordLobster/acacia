...
module.exports = {
  data: {
    name: 'add-ignored-channel-modal',
  },
  ...
  async execute(interaction, client) {
    ...
    await client.botSettings.addIgnoredChannel(interaction.guild.id, channel.id);

    const newEmbed = new EmbedBuilder()
      .setAuthor(embed.author)
      .setColor(embed.color)
      .setFooter(embed.footer)
      .setDescription(`Successfully added ${channel} to the list of ignored channels!`);
