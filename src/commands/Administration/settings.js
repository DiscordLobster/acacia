...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription('You can use the buttons below to view or change various settings for the bot! If you have any questions please don\'t hesitate to reach out to the Developer for support! You can dismiss this message at any time to stop changing settings.');
